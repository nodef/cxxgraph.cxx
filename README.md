...
- [CXXGraph](#cxxgraph)
  ...
  - [Algorithms, Classes and Network Dynamics](#algorithms-classes-and-network-dynamics)
    ...
    - [Algorithms](#algorithms)
      ...
      - [Connectivity and Component Detection](#connectivity-and-component-detection)
      - [Topological \& Dependency Sorting](#topological--dependency-sorting)
      - [Eulerian Path/Cycle Detection](#eulerian-pathcycle-detection)
      - [Graph Transformation](#graph-transformation)
      - [Graph Coloring Algorithms](#graph-coloring-algorithms)
...
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/ZigRazor/CXXGraph)
[![ORG](https://img.shields.io/badge/org-nodef-green?logo=Org)](https://nodef.github.io)
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/cxxgraph.cxx)
